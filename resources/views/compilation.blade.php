...
@section('content')
    ...
    <div class="container z-10 relative sx:px-2">
        <h2 class="text-white 2xl:text-5xl lg:text-4xl sx:text-4xl font-[400] 2xl:mt-20 sx:mt-24 2xl:mb-20">{{ $categoryName }}</h2>
        ...
        <div
            ...
            <a href="{{ route('application.view', $app->id) }}" class="">
                <div class="image-container flex justify-center items-center py-3 rounded-t-2xl">
                    <img src="{{ asset('storage/application-logo/' . $app->logo_image) }}" alt="Image 1" class="max-w-24">
