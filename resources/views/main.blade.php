...
@section('title', 'main')
@section('content')
    <div class="glide mt-10 overflow-hidden">
    ...
    <div class="container">
        <div class="flex flex-col mt-20 grid-g">
            <div>
                <a href="" class="flex gap-2 font-[400] text-2xl">Топ приложений<img
                        src="{{ asset('assets/images/arrow-right.svg') }}" alt=""></a>
            </div>
            <div class="grid grid-cols-4 gap-x-4 gap-y-7 mt-10">
    ...
    <div class="container">
        <div class="flex flex-col mt-20 grid-g">
            <div>
                <a href="" class="flex gap-2 font-[400] text-2xl">Топ игр<img
                        src="{{ asset('assets/images/arrow-right.svg') }}" alt=""></a>
            </div>
            <div class="grid grid-cols-4 gap-x-4 gap-y-7 mt-10">
                {{--            @foreach($applications as $app)--}}
        ...
        <div class="flex flex-col mt-20 grid-g">
            ...
            <div class="grid grid-cols-3 gap-10 mt-10 mb-20">
                <a href="" class="w-full relative rounded-2xl h-[180px]">
                    <img class="absolute top-0 left-0 w-full h-full object-cover filter brightness-50 rounded-2xl" src="{{ asset('assets/images/fon.svg') }}" alt="">
                    <div class="z-10 absolute top-0 left-0 w-full h-full flex items-center pl-10 text-white text-2xl">Гонки</div>
                </a>
                <a href="" class="w-full relative rounded-2xl h-[180px]">
                    <img class="absolute top-0 left-0 w-full h-full object-cover filter brightness-50 rounded-2xl" src="{{ asset('assets/images/fon.svg') }}" alt="">
                    <div class="z-10 absolute top-0 left-0 w-full h-full flex items-center pl-10 text-white text-2xl">Гонки</div>
