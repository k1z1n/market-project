...
@section('content')
    <div class="container">
        ...
        <div class="flex justify-between pb-3 border-b border-[#c5c5c5] border-opacity-60">
            ...
            <div class="text-2xl text-opacity-80 text-[#828282] flex gap-x-4 items-center"><a href="{{ route('developer.add.app') }}" class="text-[#298dff] text-sm underline">Добавить приложение +</a>Всего приложений <span class="text-black">9</span>
            </div>
        </div>
