    ...
    <div class="container">
        ...
        @else
            <div class="flex justify-center items-center mt-24 flex-col gap-y-4">
                ...
                <a href="{{ route('catalog.index') }}" class="flex text-xl text-white gap-0.5 bg-[#298DFF] rounded-lg items-center px-4 py-2">Перейти в каталог</a>
            </div>
        @endif
    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md z-[101]" id="modalWindow">
                <form action="{{ route('user.name.update') }}" method="post">
                    ...
                    <input type="text" name="username" id="editNameInput" value="@if(isset(auth()->user()->username)){{ auth()->user()->username }}@endif"
